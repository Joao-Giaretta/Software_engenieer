...
SELECT NOME, SABOR FROM TB_PRODUTOS
WHERE SABOR = 'Citrico'

SELECT NOME, IDADE FROM TB_CLIENTES
WHERE IDADE > 22

SELECT NOME, PRECO_LISTA FROM TB_PRODUTOS
WHERE PRECO_LISTA > 16

SELECT NOME, DATA_NASCIMENTO FROM TB_CLIENTES
WHERE DATA_NASCIMENTO = '25/03/92'

SELECT NOME, PRECO_LISTA, SABOR FROM TB_PRODUTOS
